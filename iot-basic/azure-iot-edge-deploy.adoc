...
. [1 基本 基本設定の構成]で各種項目を設定します。
+
image::images/iotedge-vmconfig-basic.png[]
+
.設定項目と設定値
...
. [2 サイズ 仮想マシンのサイズの選択]でサイズを選択します。
+
（本ハンズオンでは 8GB 以上のメモリが割り当てられるスペックを選択します）
+
image::images/iotedge-vmconfig-size.png[]

. [3 設定 オプション機能の構成]でパブリック受信ポートを選択で"SSH(22)"を選択します。
+
.設定項目と設定値
[cols="2*", options="header"]
|===
...
|===
+
image::images/iotedge-vmconfig-config.png[]

. [概要]で[作成]ボタンをクリックします。
+
image::images/iotedge-vmconfig-overview.png[]
