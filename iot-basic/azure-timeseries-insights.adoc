...
+
image::images/tsi-tsi-create.png[{w50}]
...
|===
+
image::images/tsi-tsi-config.png[{w50}]
...
+
image::images/tsi-explorer-temperature.png[{w50}]

. 湿度データを追加するために、サイドメニューの[Add]をクリックし、MEASUREプルダウンを”Events”から”ambient.humidity”に変更します。
+
image::images/tsi-explorer-humidity.png[{w50}]
