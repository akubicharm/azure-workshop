...
[+追加]をクリックします。
+
image::images/tsi-event-create.png[]
...
|===
+
image::images/tsi-event-config.png[]
...
+
image::images/tsi-explorer-heatmap.png[]
