...
+
image::images/asa-asa-create.png[{w50}]
...
|===
+
image::images/asa-asa-newjob.png[{w50}]
...
|===
+
image::images/asa-input-config.png[{w50}]
...
|===
+
image::images/asa-outputstorage-config.png[{w50}]
...
|===
+
image::images/asa-outputstorage-blobconfig.png[{w50}]
...
. 「演習:Azure環境の準備」で作成したリソースグループを表示し、ウィンドウ上部の[+追加]をクリックします。
+
image::images/asa-outputsql-add.png[{w50}]
...
+
image::images/asa-outputsql-createdb.png[{w50}]
...
|===
+
image::images/asa-outputsql-createoutputdb.png[{w50}]
