...
TRUSTED_ROOT_CA_CERTIFICATE_PATH = "/usr/local/share/ca-certificates/azure-iot-test-only.root.ca.cert.pem.crt"
...
def iothub_client_telemetry_sample_run():
    ...
    try:
        ...
        while True:
            ...
            if temperature > 30:
              prop_map.add("sampleAlert", "true")
            else:
              prop_map.add("sampleAlert", "false")
